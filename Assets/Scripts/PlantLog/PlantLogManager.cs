...
public class PlantLogManager : MonoBehaviour
{
    ...
    public int GetCollectedAmount(Sprite targetSprite)
    {
    ...
    public void SubtractCollectedAmount(Sprite targetSprite, int subtractAmount)
    {
        foreach (Transform child in collectionContent)
        {
            Image[] images = child.GetComponentsInChildren<Image>();
                    ...
                    treeImg.sprite.name == targetSprite.name)
                {
                    ...
                    if (currentCount == 0)
                    {
                        ...
                        LayoutRebuilder.ForceRebuildLayoutImmediate(
                            collectionContent.GetComponent<RectTransform>());
                    }
                    else
                    {
                    ...
                    // Báo cho tất cả listener biết là collection đã thay đổi
